...
function getDefaultMiddleware(options) {
    ...
    var _b = options.thunk, thunk = _b === void 0 ? true : _b; options.immutableCheck; options.serializableCheck;
...
class DropdownItem extends s$1 {
  static properties = {
